<div id="apartmentRequest-search-{{ $apartment->_id }}" class="modal" role="dialog">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control  class-input-form" name="phone" style="border-color: {{ $realestate->secondary_color }};" id="ar_phone-{{ $apartment->_id }}" value="" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
