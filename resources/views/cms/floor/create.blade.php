            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <button class="admin-form-save-btn" type="submit" form="floor-details-form-store">submit</button>
                            <button class="admin-form-close-btn-red" onclick="resetPage()">reset</button>
                            <button class="admin-form-close-btn" onclick="window.location.href='{{ route('building.edit', $building_id) }}'">close</button>
                ...
                <form method="POST" id="floor-details-form-store" action="{{route('floor.store')}}" class="form-horizontal form-label-left"
                            ...
                            <div class="row clpc active" style="display: block;">
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="name">Floor Name<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                ...
                                @if (isset($building_id) and $building_id != null)
                                <input type="text" hidden id="building_id" name="building_id" required readonly
                                    value="{{ $building_id }}" class="form-control col-12" />
                                @else
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="building_id">Building<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                            <select class="select2 select2-ajax"
                                                    id="building_id"
                                                    data-route="{{route('select.ajax','Building')}}"
                                                    data-name="name"
                                                    data-value="_id"
                                                    onchange="ajaxSelect('building_id','Building')"
                                                    name="building_id"
                                                    required>
                                                @if(old('building_id') != null)
                                                    <option value="{{old('building_id')}}" selected>
                                                        {{\App\Models\Building::find(old('building_id'))->name}}
                                                    </option>
                                                @endif
                                            </select>
                                        </div><!-- /.col-* -->
                                ...
                                {{-- <div class="col-md-6 col-12 pr-md-4 pl-md-4 p-0">
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-12" for="cover_image">Floor Cover Photo ( 900x600
                                            px )</label>
                                        <div class="control-image-field col-12 d-flex flex-row">
...
@push('js')
    <script>
        ...
        ajaxSelect('building_id', 'Building')
    </script>
