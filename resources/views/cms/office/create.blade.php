            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <button class="admin-form-save-btn" type="submit" form="office-details-form-store">submit</button>
                            <button class="admin-form-close-btn-red" onclick="resetPage()">reset</button>
                            <button class="admin-form-close-btn" onclick="window.location.href='{{ route('showroom.edit', $showroom_id) }}'">close</button>
                ...
                <form method="POST" id="office-details-form-store" action="{{route('office.store')}}" class="form-horizontal form-label-left"
                            ...
                            <div class="row clpc active" style="display: block;">
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="number">Office Number<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                ...
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="space">Office Space<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                ...
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="apartmentStatus_id">Office Status<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                            <select class="select2 select2-ajax"
                                ...
                                @if (isset($showroom_id) and $showroom_id != null)
                                <input type="text" hidden id="showroom_id" name="showroom_id" required readonly
                                    value="{{ $showroom_id }}" class="form-control col-12" />
                                @else
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="showroom_id">Floor<span class="required" style="color:red">*</span></label>
                                        <div class="col-12">
                                            <select class="select2 select2-ajax"
                                                    id="showroom_id"
                                                    ...
                                                    data-name="name"
                                                    data-value="_id"
                                                    onchange="ajaxSelect('showroom_id','Floor')"
                                                    name="showroom_id"
                                                    required>
                                                @if(old('showroom_id') != null)
                                                    <option value="{{old('showroom_id')}}" selected>
                                                        {{\App\Models\Floor::find(old('showroom_id'))->name}}
                                                    </option>
                                                @endif
                                            </select>
                                        </div><!-- /.col-* -->
