        ...
        <div class="col-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            ...
                            <button class="admin-form-close-btn" onclick="window.location.href='{{ route('floor.edit', $apartment->floor_id) }}'">close</button>
                ...
                <form id="apartment-details-form" method="POST"
                    action="{{ route('apartment.update', $apartment->_id) }}" class="form-horizontal form-label-left"
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row clpc active" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="number" name="number" required
                                                value="{{ $apartment->number }}" class="form-control col-12" />
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="space" name="space" required
                                                value="{{ $apartment->space }}" class="form-control col-12" />
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="number" id="rooms" name="rooms" required
                                                value="{{ $apartment->rooms }}" class="form-control col-12" />
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="number" id="price" name="price" required
                                                value="{{ $apartment->price }}" class="form-control col-12" />
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <select class="select2 select2-ajax" id="status_id"
                                                ...
                                                @if (isset($apartment->status))
                                                    <option value="{{ $apartment->status->_id }}" selected>
                                                        {{ $apartment->status->name }}</option>
                                                @endif
                                            </select>
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                ...
                                <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        <label class="control-label col-12" for="apartmentStatus_id">Apartment Status<span class="required"
                                                style="color:red">*</span></label>
                                        <div class="col-12">
                                            <select class="select2 select2-ajax" id="apartmentStatus_id"
                                                ...
                                                @if (isset($apartment->apartmentStatus_id))
                                                    <option value="{{ $apartment->apartmentStatus->_id }}" selected>
                                                        {{ $apartment->apartmentStatus->name }}</option>
                                                @endif
                                            </select>
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="hidden" id="floor_id" name="floor_id" required
                                                value="{{ $apartment->floor_id }}"  class="form-control col-12" />
                                            <input type="text"  required
                                                value="{{ $apartment->floor->name }}" readonly class="form-control col-12" />
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <img class="image-display" id="src-image"
                                                src="{{ $apartment->image != null ? asset($apartment->image) : asset('img/logo-placeholder.png') }}"
                                                alt="" />
                                        </div>
                                        ...
                                        <div class="control-image-field col-12 d-flex flex-row">
                                            <input type="hidden" id="hidden_image" name="hidden_image"
                                                value="{{ $apartment->image != null ? 1 : 0 }}" />
                                ...
                                <div class="col-lg-12 pr-md-12 pl-md-12 p-0 mt-md-12 mt-2" style="min-height: 60px">
                                    <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <textarea class="col-md-12 form post-text" name="description" maxlength="150">{!! $apartment->description !!}</textarea>
                                        </div><!-- /.col-* -->
                                    </div><!-- /.form-group -->
                                </div><!-- /.col-* -->
                            </div><!-- /.row.clpc -->
                                ...
                                <div class="col-md-12 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2">
                                    <div class="form-group">
                                        @include('cms.layouts.dynamic-inputs', [
                                            ...
                                            'values' => $apartment->advantage_values,
                                        ])
                                    </div>
                                </div><!-- /.col-* -->
                            </div><!-- /.row.clpc -->
