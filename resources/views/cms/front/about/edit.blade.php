    ...
    <div class="row">
        <div class="col-12">
            <div class="x_panel">
                ...
                <div class="row">
                    <form method="POST" action="{{route('about.update',$about->id)}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-12">
                                      <textarea class="form-control" id="about" name="about" rows="10"
                                                required="required">{{$about->about}}</textarea>
                                </div><!-- /.col-* -->
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                <label class="control-label col-md-2 col-12" for="address">
                                    Address
                                </label>
                                <div class="col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" id="address" name="address" required
                                           value="{{$about->address}}" class="form-control col-12 "/>
                                </div><!-- /.col-* -->
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" id="email" name="email" required
                                           value="{{$about->email}}" class="form-control col-12"/>
                                </div><!-- /.col-* -->
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" id="phone" name="phone" required
                                           value="{{$about->phone}}" class="form-control col-12"/>
                                </div><!-- /.col-* -->
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                <div style="width:100%;text-align: center;">
                                    <img src="@isset($about->image){{asset('storage/'.$about->image)}}@else{{asset('img/logo-placeholder.png')}}@endisset" id="image-holder" height="150"
