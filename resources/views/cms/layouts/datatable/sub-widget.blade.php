...
@endpush
<table class=" table ajax-table table-bordered-bottom dataTable no-footer" id="table-{{ $uId }}" cellspacing="0"
       width="100%" style="margin-top:0!important;">
    @include('cms.layouts.datatable.sub-header')
</table>
@push('js')
    @include('cms.layouts.datatable.sub-javascript',['tId'=>$uId])
@endpush
