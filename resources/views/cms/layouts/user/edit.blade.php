        ...
        <div class="col-12">
            ...
            <div class="page-title">
                <div class="title_left">
                    <h5><b style="color: black;">Edit User</b></h5>
                </div>
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <form id="user-edit-form" method="POST" action="{{route('user.update',$user->_id)}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="name" name="name" required value="{{$user->name}}" class="form-control col-md-7 col-xs-12"/>
                        </div><!-- /.col-* -->
                    </div><!-- /.form-group -->
                    ...
                    <div class="form-group">
                        <div class="cms-image">
                            <img src="@isset($user->image){{asset($user->image)}}@else{{asset('img/logo-placeholder.png')}}@endisset" id="image-holder" height="150"
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" >
                            ...
                            <input type="file" id="image" name="image" onchange="preview_image(event)"  readonly="true" >
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button class="btn btn-success btn-submit-model" type="submit" form="user-edit-form">Save</button>
