            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <button class="admin-form-save-btn" type="submit" form="contract-create-form">Submit</button>
                ...
                <div class="x_content">
                    <form id="contract-create-form" method="POST" action="{{route('role.store')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 pr-md-4 pl-md-4 p-0 mt-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" id="name" name="name" required value="{{old('name')}}" class="form-control col-12"/>
                                    </div>
                                </div>
                            </div><!-- /.col-* -->
                                        ...
                                        <table class="role-table">
                                            ...
                                            @foreach($country_permissions['list'] as $country)
                                                    <tr>
                                                        ...
                                                        <td style="width: 40%">
                                                            <input type="checkbox"  name="permissions[country][]" value="{{$country['rule']}}"  />
                                                        </td>
                                                    </tr>
                                            @endforeach
                                        </table>
